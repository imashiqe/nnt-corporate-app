...
<section class="about-preview section-padding">
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6" data-aos="fade-right"><img class="rounded-img collage-img" src="{{ asset('frontend/assets/img/about-factory.svg') }}" alt="factory collage"></div>
...
<section class="product-types section-padding">
  <div class="container text-center">
    ...
    <div class="swiper bag-type-swiper mt-4">
      <div class="swiper-wrapper">
        <div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-backpack.svg') }}" alt="Backpacks"><h3>Backpacks</h3></div></div><div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-office.svg') }}" alt="Office Bags"><h3>Office Bags</h3></div></div><div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-crossbody.svg') }}" alt="Crossbody Bags"><h3>Crossbody Bags</h3></div></div><div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-sports.svg') }}" alt="Sports Bags"><h3>Sports Bags</h3></div></div><div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-accessory.svg') }}" alt="Accessory Bags"><h3>Accessory Bags</h3></div></div><div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-delivery.svg') }}" alt="Delivery Bags"><h3>Delivery Bags</h3></div></div><div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-school.svg') }}" alt="School Bags"><h3>School Bags</h3></div></div><div class="swiper-slide"><div class="bag-type-card"><img src="{{ asset('frontend/assets/img/bag-jute.svg') }}" alt="Jute Bags"><h3>Jute Bags</h3></div></div>
      </div>
